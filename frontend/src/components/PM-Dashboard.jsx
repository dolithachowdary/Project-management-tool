    ...
    <div style={styles.container}>
      ...
      <div style={styles.mainContent}>
        ...
        {isDevOrQA && (
          <>
            {/* ✅ === DEV / QA VIEW === */}
            <h2 style={{ marginBottom: "20px" }}>Developer Dashboard</h2>
            <p>View your assigned tasks, active sprints, and progress.</p>
                ...
                {[1, 2].map((i) => (
                  <div key={i} style={styles.cardWrapper}>
                    <Card>
                      ...
                      <p style={styles.subText}>Due in {i * 3} days</p>
                      <p style={styles.smallText}>Project {i}</p>
                    </Card>
                  </div>
                ))}
            ...
            <section style={styles.section}>
              <h3 style={styles.sectionTitle}>My Progress</h3>
              <TaskGraph />
            </section>
